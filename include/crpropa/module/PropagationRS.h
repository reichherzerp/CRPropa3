#ifndef CRPROPA_PROPAGATIONRS_H
#define CRPROPA_PROPAGATIONRS_H
 ...
 */
class PropagationRS: public Module {
...
public:
	 ...
	 * @param fixedStep 
	 */
	PropagationRS(ref_ptr<MagneticField> field = NULL, double fixedStep = 1. * kpc);
	 ...
	 */
    PropagationRS(ref_ptr<MagneticField> field, double tolerance, double minStep, double maxStep);
	...
	/** Set functions for the parameters of the class PropagationRS */
	...
	/** Get functions for the parameters of the class PropagationRS, similar to the set functions */
