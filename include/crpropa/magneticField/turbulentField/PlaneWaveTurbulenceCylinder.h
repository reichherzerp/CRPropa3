#ifndef CRPROPA_PLANEWAVETURBULENCECYLINDER_H
#define CRPROPA_PLANEWAVETURBULENCECYLINDER_H
...
/**
 @class PlaneWaveTurbulenceCylinder
 ...
 */
class PlaneWaveTurbulenceCylinder : public TurbulentField {
  private:
	int Nm;
  ...
  public:
	/**
	    Create a new instance of PlaneWaveTurbulenceCylinder with the specified
...
#endif // CRPROPA_PLANEWAVETURBULENCECYLINDER_H
